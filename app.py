...
st.sidebar.markdown("---")
st.sidebar.subheader("🎯 Partenaires & Annonces")
code_regie_sidebar = """
<div style="text-align:center; background:#eff6ff; padding:10px; border-radius:6px; border:1px solid #bfdbfe;">
    <small style="color:#1e40af; font-weight:bold;">🤖 PUBLICITÉ RÉGIE AUTOMATIQUE</small>
</div>
"""
...
st.title("🏇 PMU Pro Suite Ultimate Hub v6.1")
st.info(f"👥 **Nombre total de visiteurs sur la plateforme : {total_visiteurs}**")

# BANNIÈRE PUBLICITAIRE AUTOMATIQUE DU HAUT DE PAGE
code_regie_haut = """
<div style="text-align:center; background:#fef08a; border:2px dashed #ca8a04; padding:10px; border-radius:8px; margin-bottom:10px;">
    <span style="color:#854d0e; font-weight:bold;">📢 RÉGIE INTERACTIVE : Les annonces s'activent une fois votre compte régie connecté</span>
</div>
"""
