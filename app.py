...
def auto_charger_course_pmu(reunion="R1", course="C1"):
    ...
    # URL Structurée officielle OPM PMU réparée
...
# BARRE LATÉRALE - INTÉGRATION PUBLICITAIRE BANNIÈRE VERTICALE (IFRAME ADSTERRA)
st.sidebar.markdown("---")
...
"""
st.sidebar.markdown(code_sidebar_iframe, unsafe_allow_html=True)
...
# BANNIÈRE SUPÉRIEURE HORIZONTALE ADSTERRA (b9b40b1c4e412de03b6465589ab82662)
...
"""
components.html(code_adsterra_banner_iframe, height=105, scrolling=False)

# --- ZONE VIDÉO OPTIMISÉE SANS BLOCAGE HTTP ---
st.markdown("""
<div style="background-color:#ffffff; padding:20px; border-radius:10px; border:1px solid #cbd5e1; text-align:center; margin-bottom:20px; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);">
    <h4 style="margin-top:0; color:#1e293b;">📺 Flux Vidéo & Streaming Direct</h4>
    <p style="color:#64748b; font-size:14px;">Pour contourner les protections mobiles, cliquez sur le bouton rouge ci-dessous pour ouvrir le flux live officiel gratuit sans coupure.</p>
    <a href="https://letrot.com" target="_blank" style="text-decoration:none;">
        <button style="background-color:#ef4444; color:white; border:none; padding:14px 30px; font-size:16px; font-weight:bold; border-radius:6px; cursor:pointer; width:100%; max-width:400px; transition: 0.3s;">
            ▶️ ASSISTER AU DIRECT LIVE (LETROT GRATUIT)
        </button>
    </a>
</div>
""", unsafe_allow_html=True)
