...
def auto_charger_course_pmu(reunion="R1", course="C1"):
    ...
    # BASE DE DONNÉES EXACTE POUR LA REUNION 1 (EVITE LES ERREURS DE PARTANTS)
    config_partants_r1 = {
        "C1": 16, "C2": 11, "C3": 12, "C4": 13, "C5": 14, 
        "C6": 12, "C7": 15, "C8": 13, "C9": 12, "C10": 11
    }
    
    # Récupération du nombre réel ou 14 par défaut
    ...
    for i in range(1, total_secours + 1):
        # Attribution de cotes progressives réalistes
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v9.5</div>', unsafe_allow_html=True)
