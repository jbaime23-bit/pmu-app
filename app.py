...
# --- [PUBLICITÉ 1] : LE CODE REBRANCHÉ ET SÉCURISÉ EN HAUT ---
code_adsterra_haut = """
...
# --- [PUBLICITÉS 2 & 3 EN PERMANENCE] : CORRECTION DE LA CLÉ MIXTÉ ---
st.markdown("---")
...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; width: 100%;">
    ...
    <!-- Deuxième Publicité : CPM Network (Clé 548477...) -->
    ...
    <!-- Troisième Publicité : Correction de la clé Adsterra (Clé b9b4...) -->
    <div style="min-width: 300px; text-align: center;">
        <script type="text/javascript">
          atOptions = {'key' : 'b9b40b1c4e412de03b6465589ab82662', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {}};
        </script>
