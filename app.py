...
# --- [PUBLICITÉ 1] : BLOC DE TÊTE ADSTERRA ---
code_adsterra_haut = """
...
with col2:
    ...
    if not st.session_state.ad_played:
        ...
        # Application stricte de tes paliers d'analyse
        ...
        # Remplissage de sécurité pour atteindre exactement 9 chiffres uniques
...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; width: 100%;">
    ...
    <!-- Troisième Publicité : Adsterra Corrigée et refermée -->
    <div style="min-width: 320px; text-align: center; margin-bottom: 10px;">
        <script type="text/javascript">
          atOptions = {
