...
# --- TRI DYNAMIQUE DE L'IA EN FONCTION DES COTES ---
num_ia_trie = []
# Tri numérique sur la cote réelle calculée (le favori en premier)
cotes_triees_par_valeur = sorted(cotes_s.items(), key=lambda item: item[1])

for cheval_nom, _ in cotes_triees_par_valeur:
    try:
        if " - " in cheval_nom:
            partie_numero = cheval_nom.split(" - ")[0]
...
# Répartition selon votre logique de pronostics hippiques
...
# --- LISTE DES PARTICIPANTS CORRIGÉE ET SÉCURISÉE ---
