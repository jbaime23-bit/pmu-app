...
# --- CONFIGURATION DE LA SÉLECTION AUTOMATIQUE IA ---
...
if st.session_state.ad_played:
    ...
    st.markdown("""
        <div style="text-align: center; margin-top: 10px; margin-bottom: 15px;">
            <a href="https://lescourseshippiques.fr" target="_blank" style="display: inline-block; padding: 12px 24px; background-color: #22c55e; color: white; font-weight: bold; text-decoration: none; border-radius: 8px; border: 2px solid #16a34a; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.1);">
                📺 ACCÉDER IMMÉDIATEMENT AU DIRECT ICI
            </a>
        </div>
    """, unsafe_allow_html=True)
...
# --- [MONÉTISATION 3] : DEUXIÈME BANNIÈRE PUBLICITAIRE EN BAS DE PAGE (Clé 548477c48bb33989924ab69d7a4e0cc1) ---
st.markdown("---")
code_adsterra_banner_bas = """
<div style="width: 100%; overflow-x: auto; text-align: center; margin-top: 20px; -webkit-overflow-scrolling: touch;">
    <div style="min-width: 728px; display: inline-block;">
...
"""
components.html(code_adsterra_banner_bas, height=110, scrolling=False)
