...
def auto_charger_course_pmu(reunion="R1", course="C1"):
    ...
    # BASE DE DONNÉES EXACTE DE SECOURS POUR LES PARTANTS
    config_partants_r1 = {
...
<div style="text-align:center; background-color:#1e293b; padding:15px; border-radius:8px; border:1px solid #3b82f6;">
  ...
  <small style="color:#94a3b8;">Bannières publicitaires synchronisées au centre de la page.</small>
</div>
""", unsafe_allow_html=True)
st.sidebar.markdown("---")
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v16.0</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE GÉANTE ENCAPSULÉE SÉCURISÉE ---
...
# --- CORRECTION FINALE DU TRI DU DICTIONNAIRE .ITEMS() PYTHON ---
