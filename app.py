...
# --- CRÉATION SÉCURISÉE DE LA LISTE TYPE ET SELECTION DE L'IA ---
liste_couple_triee = []

for cle_nom, valeur_cote in cotes_s.items():
    try:
        # Isole les chiffres (ex: "N°12 - Etonnant" -> 12)
...
# Reste : choisi 2 chiffres dans les cotes restantes, en éliminant les 2 derniers
...
# Sécurité pour garantir exactement 9 numéros uniques
