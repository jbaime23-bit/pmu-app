...
if 'total_visiteurs' not in st.session_state:
    st.session_state.total_visiteurs = 21  # On reprend votre score actuel visible sur l'écran
...
# 4. BARRE LATÉRALE ÉPURÉE (SANS ABONNEMENT NI NUMÉROS)
...
with onglet1:
    ...
    # Champ de texte simplifié sans interaction de fichier externe
    ...
    st.divider()
    st.subheader("🛠️ Ajustement Manuel des Enjeux (€)")
