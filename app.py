...
st.sidebar.markdown("---")
# --- [PUBLICITÉ 2] : ENCAPSULATION DE SÉCURITÉ SIDEBAR HIPPIC ---
code_sidebar_ad = """
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v11.2</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE ENCAPSULÉE SÉCURISÉE (728px FORCÉ) ---
code_adsterra_banner_728 = """
<div style="width: 100%; text-align: center; overflow-x: auto; -webkit-overflow-scrolling: touch; margin-bottom: 15px;">
  <div style="display: inline-block; min-width: 728px; height: 90px;">
    <script type="text/javascript">
      atOptions = {'key' : 'b9b40b1c4e412de03b6465589ab82662', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {}};
    </script>
...
# --- AFFICHAGE FLUIDE ET EN HAUTE COMPATIBILITÉ MOBILE ---
if st.session_state.ad_played:
