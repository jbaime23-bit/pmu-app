...
# --- REPARATION APPLIQUEE SUR LA LIGNE 117 (item -> item[0]) ---
cotes_triees = sorted(cotes_s.items(), key=lambda item: item[1])
num_ia_trie = []
for item in cotes_triees:
    # item[0] extrait la chaîne de texte "N°X - Nom du cheval" depuis le tuple
...
# --- STRUTURE DE LA VIDEO INTERMEDIAIRE DE 5 SECONDES ---
...
with onglet1:
    ...
    # BANNIÈRE NATIVE ADSTERRA SÉCURISÉE SANS RECOUPURE INTERNE
