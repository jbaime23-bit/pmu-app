...
# Personnalisation de l'interface (Design Sombre, Pleine Largeur & Espace de défilement)
st.markdown("""
<style>
    ...
    /* MARGE DE SÉCURITÉ ABSOLUE EN BAS : force le défilement et l'apparition du contenu masqué par le bouton système */
    .main .block-container {padding-bottom: 400px !important;}
</style>
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v12.1</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE GÉANTE RESTAURÉE ---
...
# --- AFFICHAGE GENERAL EN LARGEUR MAXIMALE ---
if st.session_state.ad_played:
