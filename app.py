...
st.sidebar.markdown("---")
# --- [PUBLICITÉ 2] : BINDING SIDEBAR LARGE ET FIXE ---
code_sidebar_ad = """
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v10.0</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE TRÈS LARGE (PLEINE LARGEUR VISUELLE) ---
...
# --- AFFICHAGE FLUIDE EN CASCADE UNIQUE POUR ÉVITER LES SQUEEZES SUR MOBILE ---
if st.session_state.ad_played:
    ...
    # 1. LE TABLEAU BLANC DES CHEVAUX PREND TOUTE LA LARGEUR MOBILE POUR S'OUVRIR PROPREMENT
