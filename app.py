...
def auto_charger_course_pmu(reunion="R1", course="C1"):
    ...
    # Secours dynamique corrigé avec des cotes arrondies proprement (ex: 5.2, 7.4, 9.6)
...
# --- [PUBLICITÉ 1] : LE CODE D'ORIGINE QUI MARCHAIT EN HAUT ---
code_adsterra_haut = """
...
# --- [PUBLICITÉS 2 & 3] : ZONE SÉPARÉE POUR LES AUTRES PUBLICITÉS DU BAS ---
st.markdown("---")
...
<div style="display: flex; justify-content: center; gap: 20px; flex-wrap: wrap; width: 100%;">
    ...
    <!-- Troisième Publicité : Adsterra 2ème Bloc -->
    <div style="min-width: 300px; text-align: center;">
        <script type="text/javascript">
          atOptions = {'key' : '548477c48bb33989924ab69d7a4e0cc1', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {}};
        </script>
        <script type="text/javascript" src="https://highrevenueformat.com"></script>
    </div>
