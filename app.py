...
# --- PANNEAU DE CONTROLE CACHÉ (INVISIBLE POUR LES UTISATEURS) ---
st.sidebar.markdown("---")
activation_console = st.sidebar.checkbox("Activer la console", value=False, help="Réservé au créateur")
...
if activation_console:
    if not st.session_state.est_admin_connecte:
        ...
        st.session_state.total_visiteurs = st.sidebar.number_input("Compteur visiteurs", value=st.session_state.total_visiteurs)
...
# --- ESPACE PUBLICITAIRE : INTEGRATION VIA URL DIRECTE ADSTERRA CORRIGÉE ---
