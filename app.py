...
# Injection CSS et intégration directe des publicités de fond et du style général
st.markdown("""
<style>
    ...
    .ad-container-fixed {text-align: center; margin: 15px 0; min-height: 90px; width: 100%;}
</style>
""", unsafe_allow_html=True)

# 📢 [PUBLICITÉ 1/3] : INJECTION DU SCRIPT INVISIBLE POPUNDER DIRECTEMENT DANS LA PAGE
st.markdown('<script src="https://profitableratecpmnetwork.com"></script>', unsafe_allow_html=True)
...
# 📢 [PUBLICITÉ 2/3] : INJECTION DIRECTE SANS IFRAME DE LA BANNIÈRE HAUT ADSTERRA
# Intégration en HTML pur pour contourner la restriction de cadre blanc de Streamlit
code_adsterra_direct = """
<div class="ad-container-fixed">
...
"""
st.markdown(code_adsterra_direct, unsafe_allow_html=True)
...
# 📢 [PUBLICITÉ 3/3] : INJECTION DIRECTE SANS IFRAME DU BLOC BAS CPM NETWORK
code_cpm_bas_direct = """
<div class="ad-container-fixed">
...
"""
st.markdown(code_cpm_bas_direct, unsafe_allow_html=True)
