...
# INTERFACE PRINCIPALE RECTIFIÉE (FLUIDE ET LARGE)
...
# --- ESPACE PUBLICITAIRE : INTEGRATION FILTRÉE ANTI-BLOCAGE ADSTERRA ---
st.markdown("### 📢 Partenaire Officiel")
code_adsterra_iframe = """
<div style="text-align:center; width:100%;">
    <iframe src="https://highrevenueformat.com" width="728" height="90" style="border:none; overflow:hidden; background-color:#fafafa;" scrolling="no"></iframe>
</div>
"""
components.html(code_adsterra_iframe, height=110, scrolling=False)
...
if not st.session_state.pub_video_regardee:
    if st.button("🔓 Débloquer la Sélection Automatique de l'IA (Vidéo 5s)", type="primary"):
        ...
        for pct in range(1, 6):
            time.sleep(1)
            barre_progression.progress(pct * 20)
