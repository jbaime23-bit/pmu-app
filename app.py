...
st.sidebar.markdown("---")
# --- [PUBLICITÉ 2] : BANNIÈRE SIDEBAR RESTAURÉE LARGE ---
code_sidebar_ad = """
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v9.8</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE TRÈS LARGE (RESTAURÉE D'ORIGINE) ---
...
# --- AFFICHAGE EN DOUBLE ÉCRAN (TABLEAU À GAUCHE / PUBLICITÉ À DROITE) ---
if st.session_state.ad_played:
    ...
    # Création du double écran (Configuration 2 colonnes comme à la télé)
