...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v10.3</div>', unsafe_allow_html=True)
...
if st.session_state.ad_played:
    ...
    # 1. LE TABLEAU DES CHEVAUX EN PLEINE LARGEUR VISUELLE
