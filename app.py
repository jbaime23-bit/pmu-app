...
# Personnalisation de l'interface (Design Sombre, Pleine Largeur Mobile)
st.markdown("""
<style>
...
st.sidebar.markdown("---")
# --- [PUBLICITÉ 2] : BLOC BANNIÈRE SIDEBAR (ADSTERRA FORCÉ 750PX) ---
code_sidebar_ad = """
...
"""
st.sidebar.markdown('<p style="color:white; font-weight:bold; text-align:center;">📊 ANNONCE PUBLICITAIRE</p>', unsafe_allow_html=True)
components.html(code_sidebar_ad, height=105, width=750, scrolling=True)
st.sidebar.markdown("---")
st.sidebar.write("📧 **Contact :** jb.aime23@gmail.com")

# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v14.0</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE GÉANTE (FENÊTRE FORCÉE POUR ÉVITER LE BLOCAGE ADSTERRA) ---
...
"""
components.html(code_adsterra_banner_728, height=115, width=750, scrolling=True)
...
# --- CORRECTION STRICTE DE LA STRATEGIE DE TRI PYTHON ---
...
# --- RENDU DE LA PAGE EN FORMAT MOBILE ET PLEINE GRILLE ---
if st.session_state.ad_played:
