...
code_regie_sidebar = '<div style="text-align:center; background:#eff6ff; padding:10px; border-radius:6px; border:1px solid #bfdbfe;"><small style="color:#1e40af; font-weight:bold;">🤖 PUBLICITÉ BANQUE D'ANNONCES</small></div>'
...
def calculus_combinés(mises, taux_comb):
