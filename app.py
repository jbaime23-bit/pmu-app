...
# --- [MONÉTISATION 3] : BANNIÈRE DE LA SIDEBAR (Espace Pub Supplémentaire) ---
...
# --- [MONÉTISATION 1] : BANNIÈRE PUBLICITAIRE EN HAUT (Adsterra) ---
...
with col1:
    ...
    if not st.session_state.start_countdown and not st.session_state.ad_played:
        if st.button("⚡ Générer la Sélection Stratégique", type="primary"):
            ...
            # [MONÉTISATION 2] : Script Interstitiel / Popunder CPM Network au déclenchement
...
with col2:
    ...
    if not st.session_state.ad_played:
        ...
        # CORRECTION DU BUG DE TRI : Extraction propre des clés et valeurs du dictionnaire
