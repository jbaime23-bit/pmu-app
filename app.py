...
# Personnalisation de l'interface (Design Sombre, Masquage Bouton Streamlit & Pleine Largeur)
st.markdown("""
<style>
    #MainMenu {visibility: hidden;} 
    footer {visibility: hidden;} 
    /* Force l'application à utiliser 100% de la largeur disponible sur mobile */
    ...
    /* Masque le bouton système noir "Manage app" pour libérer l'espace en bas */
    iframe[title="Manage app"], div[data-testid="stManageAppButton"] {display: none !important; visibility: hidden !important;}
</style>
...
st.sidebar.markdown("---")
# --- [PUBLICITÉ 2] : ANNONCE SIDEBAR GRAND FORMAT ---
code_sidebar_ad = """
...
"""
components.html(code_sidebar_ad, height=105, scrolling=False)
st.sidebar.markdown("---")
st.sidebar.write("📧 **Contact :** jb.aime23@gmail.com")

# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v12.0</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE GÉANTE RESTAURÉE (PLEINE LARGEUR HORIZONTALE) ---
code_adsterra_banner_728 = """
<div style="width: 100%; text-align: center; overflow-x: auto; margin-bottom: 20px;">
  <div style="display: inline-block; min-width: 728px; height: 90px;">
    <script type="text/javascript">
      atOptions = {'key' : 'b9b40b1c4e412de03b6465589ab82662', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {}};
    </script>
...
"""
components.html(code_adsterra_banner_728, height=115, scrolling=False)
...
# --- CONFIGURATION ET TRI DE L'ALGORITHME IA ---
...
# --- AFFICHAGE GENERAL EN LARGEUR MAXIMALE HAUTE COMPATIBILITÉ ---
if st.session_state.ad_played:
