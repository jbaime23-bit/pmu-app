...
with onglet1:
    ...
    # REHAUSSEMENT DU COMPOSANT : height=280 pour éviter l'écran blanc sur mobile
    ...
    <div id="container-548477c48bb33989924ab69d7a4e0cc1" style="display:inline-block; margin:0 auto;"></div>
    </div>
    """
    components.html(code_adsterra_native_deplacee, height=280, scrolling=False)
