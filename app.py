...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v10.6</div>', unsafe_allow_html=True)
...
# --- CORRECTION FINALE ET SÉCURISÉE DU TRI PYTHON ---
...
if st.session_state.ad_played:
    ...
    # 1. TABLEAU DES CHEVAUX EN PLEINE LARGEUR
