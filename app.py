...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v10.1</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE LARGE D'ORIGINE ---
...
# --- AFFICHAGE FLUIDE EN CASCADE UNIQUE POUR MOBILE ---
if st.session_state.ad_played:
