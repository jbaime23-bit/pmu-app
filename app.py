...
st.sidebar.markdown("---")
# --- [PUBLICITÉ 2] : BINDING SIDEBAR LARGE ---
code_sidebar_ad = """
<div style="text-align:center; width:100%; min-height:90px;">
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v10.4</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE LARGE ---
code_adsterra_banner_728 = """
<div style="width: 100%; text-align: center; display: block; clear: both; margin-bottom: 15px;">
    <script type="text/javascript">
      atOptions = {'key' : 'b9b40b1c4e412de03b6465589ab82662', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {}};
    </script>
    <script type="text/javascript" src="https://highrevenueformat.com"></script>
...
# --- CALCUL DE L'ALGORITHME DES PRONOSTICS ---
...
# --- AFFICHAGE FLUIDE EN CASCADE UNIQUE ---
if st.session_state.ad_played:
    ...
    # 1. SYNTAXE DE CONSTRUCTION DIRECTE DU TABLEAU DES CHEVAUX (ANTI-PLANTAGE)
    st.markdown('<p style="color:white; font-weight:bold; margin-top:15px;">📋 GRILLE COMPLETE DES CHEVAUX</p>', unsafe_allow_html=True)
    
    tableau_partants = [
        {"N° Numéro": int(num), "Nom du Cheval": str(details["nom"]), "Cote Actuelle": f"{details['cote']:.1f}"}
