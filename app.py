...
# --- EMPLACEMENT PUBLICITAIRE TOP EN REMPLACEMENT DE L'ESPACE AUTEUR ---
st.sidebar.header("📢 Espace Sponsor Premium")
code_regie_top_sidebar = """
<div style="text-align:center; background:#fff7ed; padding:12px; border-radius:6px; border:2px dashed #ea580c; margin-bottom:5px;">
    <small style="color:#c2410c; font-weight:bold;">🚀 PUBLICITÉ TOP SIDEBAR AUTOMATIQUE</small>
    <br><span style="font-size:10px; color:#666;">(Bannière à forte valeur ajoutée)</span>
</div>
"""
...
code_regie_sidebar = """
<div style="text-align:center; background:#eff6ff; padding:10px; border-radius:6px; border:1px solid #bfdbfe;">
    <small style="color:#1e40af; font-weight:bold;">🤖 PUBLICITÉ BANQUE D'ANNONCES</small>
</div>
"""
...
st.sidebar.markdown(f'<a href="{lien_whatsapp}?text=Je%20souhaite%20soutenir%20l%27application" target="_blank" style="text-decoration:none;"><button style="background-color:#e11d48; color:white; border:none; padding:8px 15px; border-radius:5px; cursor:pointer; width:100%; font-weight:bold; margin-top:5px;">💰 Soutenir l\'auteur (Don Mobile Money)</button></a>', unsafe_allow_html=True)
...
st.title("🏇 PMU Pro Suite Ultimate Hub v6.2")
st.info(f"👥 **Nombre total de visiteurs sur la plateforme : {total_visiteurs}**")

code_regie_haut = """
<div style="text-align:center; background:#fef08a; border:2px dashed #ca8a04; padding:10px; border-radius:8px; margin-bottom:10px;">
