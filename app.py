...
def generer_9_chiffres_depuis_remarques(mises_dict, specialite):
    ...
    if zone_1:
        try:
            nb_a_prendre = random.choice([1, 2]) # CORRECTION : Choix 1 ou 2 configuré
    ...
    if zone_3:
        try:
            nb_a_prendre_z3 = random.choice([1, 2]) # CORRECTION : Choix 1 ou 2 configuré
...
# --- SCRIPT ADSTERRA OFFICIEL EMBARQUÉ SANS BLOCAGE ---
