...
with col2:
    ...
    if not st.session_state.ad_played:
        ...
        # Application des paliers liste type
...
# Affichage sous forme de tableau propre pour les utilisateurs
tableau_chevaux = []
...
# --- [PUBLICITÉ 2] : NOUVEAU BLOC BAS CPM NETWORK ---
