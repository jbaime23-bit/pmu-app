...
# --- [PUBLICITÉ 1] : LE CODE ADSTERRA HAUT QUI FONCTIONNE ---
code_adsterra_haut = """
...
with col1:
    ...
    if st.session_state.ad_played:
        ...
        # --- BOUTON DU DIRECT EQUIDIA RÉACTIVÉ ---
        st.markdown("""
...
if st.session_state.ad_played:
    ...
    for n_chv, info_chv in liste_triee_affichage:
        st.write(f"腔 **Cheval N°{n_chv}** : {info_chv['nom']} — 📊 Cote réelle : `{info_chv['cote']}`")

# --- [PUBLICITÉS 2 & 3] : LES CODES DE BAS QUI FONCTIONNENT ---
st.markdown("---")
