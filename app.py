...
# --- CORRECTION DU TRI : Tri basé sur la valeur numérique réelle de la cote ('cote') ---
...
if st.session_state.ad_played:
    ...
    # 💰 Affichage de la Masse des Enjeux
    ...
    # Création de colonnes propres pour l'affichage de la liste complète des partants
    for n_chv in num_liste_type:
        nom_chv = donnees_chevaux[n_chv]["nom"]
        cote_chv = donnees_chevaux[n_chv]["cote"]
        st.write(f"🏇 **Cheval N°{n_chv}** : {nom_chv} — 📊 Cote : `{cote_chv}`")
