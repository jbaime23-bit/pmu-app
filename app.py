...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v11.0</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE GÉANTE RESTAURÉE (100% LARGEUR) ---
code_adsterra_banner_728 = """
<div style="width: 100%; text-align: center; display: block; clear: both; margin-bottom: 20px;">
    <script type="text/javascript">
      atOptions = {'key' : 'b9b40b1c4e412de03b6465589ab82662', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {}};
    </script>
    <script type="text/javascript" src="https://highrevenueformat.com"></script>
...
if st.session_state.ad_played:
    ...
    # REMPLACEMENT PAR UN DIRECT LIVE MULTI-RESEAUX ACCESSIBLE SANS BLOCAGE (YOUTUBE LIVE HIPPIC)
    st.markdown("""
...
# --- RESTAURATION DU MODE DE DOUBLE ÉCRAN LARGE ---
if st.session_state.ad_played:
    ...
    # Séparation en 2 colonnes fixes pour imiter les deux écrans télé
