...
# --- 📢 [PUBLICITÉ 1/3] : SCRIPT POPUNDER INVISIBLE ---
# Placé de manière brute et isolée à sa hauteur minimale
components.html(
...
def calculer_course_mathematique(reunion="R1", course="C1"):
    ...
    # Nombre de partants déterministe et fixe par course
...
# --- 📢 [PUBLICITÉ 2/3] : BANNIÈRE HAUT ADSTERRA COMPLÈTEMENT ISOLÉE ---
# Strictement identique à votre code d'origine qui marchait sans aucune balise div autour
code_adsterra_brut = """
...
"""
components.html(code_adsterra_brut, height=100, scrolling=False)
...
# --- 📢 [PUBLICITÉ 3/3] : BLOC BAS CPM NETWORK BRUT ISOLÉ ---
# Retrait des conteneurs Python pour forcer le chargement de la régie
code_cpm_bas_brut = """
...
"""
components.html(code_cpm_bas_brut, height=130, scrolling=False)
