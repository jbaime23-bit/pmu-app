...
# INTERFACE PRINCIPALE (PRÉSENTATION LARGE EN HAUTEUR)
...
# --- ESPACE PUBLICITAIRE BANNIÈRE ADSTERRA ACTIF ---
st.markdown("### 📢 Partenaire Officiel")
code_adsterra = """
<div style="text-align:center; width:100%; min-height:90px; background-color:#fafafa; border:1px solid #ddd; padding:5px;">
...
"""
components.html(code_adsterra, height=110, scrolling=False)

# --- FLUX LIVE EQUIDIA (DISPOSITION REVENUE EN LARGEUR NORMALE) ---
st.subheader("📺 Diffusion Equidia Live")
code_equidia = """
<div style="width:100%; text-align:center;">
    <iframe src="https://equidia.fr" width="100%" height="400" style="border:none; border-radius:8px;" allowfullscreen></iframe>
</div>
"""
components.html(code_equidia, height=420)
...
# Graphique d'enjeux (Altair) rétabli en grand format au-dessus ou à côté
