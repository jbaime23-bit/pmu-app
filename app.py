...
# --- REPARATION DEFINITIVE DE LA LIGNE 117 ---
cotes_triees = sorted(cotes_s.items(), key=lambda item: item[1])
num_ia_trie = []
for item in cotes_triees:
    # Ciblage strict du premier index item[0] pour extraire la chaîne "N°X - Cheval"
...
# --- ADSTERRA POPUNDER AVEC COMPTE À REBOURS DE 5 SECONDES ---
...
with onglet1:
    ...
    # Intégration iframe stable pour l'affichage permanent
