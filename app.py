...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v11.1</div>', unsafe_allow_html=True)
...
# --- AFFICHAGE EN DOUBLE ÉCRAN TELE CORRIGÉ ---
if st.session_state.ad_played:
    ...
    # Division stricte en 2 blocs distincts pour le double écran mobile
    col_gauche, col_droite = st.columns(2)
    
    with col_gauche:
        st.markdown('<p style="color:white; font-weight:bold;">📋 GRILLE DES CHEVAUX</p>', unsafe_allow_html=True)
        nums_list = []
        noms_list = []
        cotes_list = []
