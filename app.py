...
st.sidebar.markdown("---")
# --- [PUBLICITÉ 2] : ANNONCE SIDEBAR AVEC ENVELOPPE LARGEUR FORCÉE ---
code_sidebar_ad = """
...
"""
st.sidebar.markdown('<p style="color:white; font-weight:bold; text-align:center;">📊 REGIE ADSTERRA</p>', unsafe_allow_html=True)
components.html(code_sidebar_ad, height=105, width=750, scrolling=True)
st.sidebar.markdown("---")
st.sidebar.write("📧 **Contact :** jb.aime23@gmail.com")

# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v13.1</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE AVEC LARGEUR 750PX ET SCROLLING FORCÉ POUR MOBILE ---
...
"""
components.html(code_adsterra_banner_728, height=110, width=750, scrolling=True)
...
# --- AFFICHAGE EN PLEINE LARGEUR DES RÉSULTATS ---
if st.session_state.ad_played:
