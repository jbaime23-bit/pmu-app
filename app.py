...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v10.5</div>', unsafe_allow_html=True)
...
if st.session_state.ad_played:
    ...
    # 1. ARCHITECTURE SIMPLIFIEE ET SECURISEE DU TABLEAU (SANS ALIGNEMENT DE CROCHETS)
