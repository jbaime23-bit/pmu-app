...
<div style="text-align:center; background-color:#eff6ff; padding:15px; border-radius:8px; border:2px solid #3b82f6;">
    ...
    <small style="color:#1d4ed8;">Régie Adsterra connectée</small>
</div>
...
# INTERFACE INTERACTIVE v8.3
st.title(" 🏇 PMU Pro Suite Ultimate Hub v8.3")
st.info(f"👥 **Nombre total de visiteurs sur la plateforme : {st.session_state.total_visiteurs}**")

# --- INTÉGRATION DE VOTRE VRAI SCRIPT ADSTERRA EN HAUT DE PAGE ---
code_adsterra_officiel = """
...
"""
components.html(code_adsterra_officiel, height=100)
