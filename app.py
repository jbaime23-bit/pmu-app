...
# --- [PUBLICITÉ 1] : LE REVENU D'ORIGINE ADSTERRA HAUT REBRANCHÉ ---
code_adsterra_haut = """
...
with col2:
    ...
    if not st.session_state.ad_played:
        ...
        # --- CORRECTION FINALE DU BUG DE TRI DE L'IA (Ligne 113 réparée) ---
...
# --- [PUBLICITÉS 2 & 3] : BLOC DE BAS PERMANENT ET RECONNU ---
st.markdown("---")
