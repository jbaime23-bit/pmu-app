...
code_sidebar_ad = """
<div style="width: 100%; text-align: center; overflow-x: scroll; -webkit-overflow-scrolling: touch;">
...
# --- LE HUB CENTRAL ---
st.markdown(f'<div class="main-title">🏇 PMU Pro Suite Ultimate Hub v13.0</div>', unsafe_allow_html=True)

# --- [PUBLICITÉ 1] : BANNIÈRE HAUTE LARGE AVEC DEFILEMENT MOBILE FORCÉ ---
code_adsterra_banner_728 = """
<div style="width: 100%; text-align: center; overflow-x: scroll; -webkit-overflow-scrolling: touch; margin-bottom: 20px;">
  <div style="display: inline-block; min-width: 728px; height: 90px;">
    <script type="text/javascript">
      atOptions = {'key' : 'b9b40b1c4e412de03b6465589ab82662', 'format' : 'iframe', 'height' : 90, 'width' : 728, 'params' : {}};
    </script>
...
# --- CORRECTION APPLIQUÉE ET SÉCURISÉE DU TRI PYTHON HIPPIC ---
...
# --- AFFICHAGE FLUIDE EN CASCADE DE SÉCURITÉ ---
if st.session_state.ad_played:
