...
# --- CORRECTION DE LA LIGNE 115 (Tri par valeurs et extraction propre sur la clé texte) ---
cotes_triees = sorted(cotes_s.items(), key=lambda item: item[1])
num_ia_trie = []
for item in cotes_triees:
    # item[0] correspond au texte "N°X - NomDuCheval"
...
with onglet1:
    # --- BANNIÈRE NATIVE REPLONGÉE ICI SUR LE PREMIER ONGLET ---
