...
# INTERFACE INTERACTIVE v8.0
st.title(" 🏇 PMU Pro Suite Ultimate Hub v8.0")
...
# --- 1. LECTEUR DE FLUX DIRECT INTÉGRÉ ---
with st.expander("📺 Regarder la course en Direct (Live Flux)", expanded=True):
    st.caption("Le flux en direct s'adapte automatiquement à l'heure du départ.")
    # Intégration d'un lecteur de streaming direct standardisé (ex: Equidia ou YouTube Live)
    components.html('<iframe src="https://youtube.com" width="100%" height="315" frameborder="0" allowfullscreen></iframe>', height=320)
...
with onglet1:
    ...
    # --- 2. BOUTON D'AUTOMATISATION DE L'IA ---
    col_btn1, col_btn2 = st.columns([3, 1])
    with col_btn2:
        if st.button("🤖 Générer via l'IA"):
            # L'IA extrait automatiquement les numéros spéculatifs optimaux de la course du direct
