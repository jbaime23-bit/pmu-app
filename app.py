...
# INTERFACE INTERACTIVE v8.6
st.title(" 🏇 PMU Pro Suite Ultimate Hub v8.6")
...
# --- FLUX EN DIRECT SÉCURISÉ ---
with st.expander("📺 Regarder la course Equidia Live en Direct", expanded=True):
    components.html('<iframe src="https://lescourseshippiques.fr" width="100%" height="450" frameborder="0" allowfullscreen></iframe>', height=460)
...
with onglet3:
    ...
    if not st.session_state.video_vue and not st.session_state.est_admin:
        ...
        code_adsterra_native = '<div style="text-align:center; margin-bottom:10px;"><script async="async" data-cfasync="false" src="https://pl31390924.profitableratecpmnetwork.com/548477c48bb33989924ab69d7a4e0cc1/invoke.js"></script><div id="container-548477c48bb33989924ab69d7a4e0cc1"></div></div>'
