...
def auto_charger_course_pmu(reunion="R1", course="C1"):
    ...
    # URL corrigée pour pointer vers l'API officielle du PMU
    ...
    # Secours dynamique si l'API PMU ne répond pas ou est bloquée
...
# Bouton pour forcer le rafraîchissement des données en temps réel
...
# --- GESTION DU COMPTE À REBOURS ET DE L'INTERSTITIEL ---
...
# Application stricte des règles de paliers de sélection numérique
...
# Sécurité pour avoir toujours 9 numéros uniques
...
if st.session_state.ad_played:
    ...
    # Tableau récapitulatif des partants trié par cote
    tableau_partants = []
